...
import weighmentRoutes from './routes/weighment.routes.js';
...
import { ensureReferenceData } from './bootstrap/ensureReferenceData.js';
...
app.use('/api/v1/weighments', weighmentRoutes);
